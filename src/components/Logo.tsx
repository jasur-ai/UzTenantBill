...
export default function Logo({ size = 32, variant = 'default' }: LogoProps) {
  if (variant === 'compact') {
    return (
      <svg width={size} height={size} viewBox="0 0 40 40" fill="none" xmlns="http://www.w3.org/2000/svg">
        <defs>
          <linearGradient id="lgC" x1="8" y1="8" x2="32" y2="32" gradientUnits="userSpaceOnUse">
            ...
            <stop offset="1" stopColor="#0284c8" />
          </linearGradient>
        </defs>
        <path d="M9 10 Q9 30 20 30 Q31 30 31 10" stroke="url(#lgC)" strokeWidth="8" strokeLinecap="round" fill="none" />
        <path d="M14 20 L20 13 L26 20" stroke="#38bdf8" strokeWidth="3.5" strokeLinecap="round" />
    ...
    <svg width={size} height={size} viewBox="0 0 46 46" fill="none" xmlns="http://www.w3.org/2000/svg">
      <defs>
        <linearGradient id="lgV10" x1="4" y1="4" x2="42" y2="42" gradientUnits="userSpaceOnUse">
          <stop stopColor="#0ea5e9" />
          <stop offset="0.3" stopColor="#0284c8" />
        ...
        <filter id="shV10" x="-50%" y="-50%" width="200%" height="200%">
          <feDropShadow dx="0" dy="2" stdDeviation="2.8" floodColor="#0ea5e9" floodOpacity="0.38" />
        </filter>
      </defs>

      {/* Powerful outer U */}
      <path d="M7 6 Q7 40 23 40 Q39 40 39 6" stroke="url(#lgV10)" strokeWidth="10.8" strokeLinecap="round" fill="none" />

      {/* Inner depth layer */}
      <path d="M11 10 Q11 36 23 36 Q35 36 35 10" stroke="#0f172a" strokeWidth="3.8" strokeLinecap="round" fill="none" opacity="0.18" />

      {/* Building icon */}
      <path d="M15 22 L23 13 L31 22" stroke="url(#acV10)" strokeWidth="3.9" strokeLinecap="round" strokeLinejoin="round" />
