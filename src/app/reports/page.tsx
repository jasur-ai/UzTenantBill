...
function ReportsContent() {
  ...
  const showRecentDownloads = () => {
    ...
    try {
      ...
      if (recent.length === 0) {
        container.innerHTML = `<div style="font-size:13.5px; color:var(--text-secondary);">Hali hisobot yuklanmagan. Yuqoridagi tugmalardan birini bosing.</div>`;
        return;
      }
      ...
      recent.forEach((item: any) => {
        ...
        html += `<div style="margin-bottom:6px; padding:4px 0; border-bottom:1px solid var(--card-border);">✅ <strong>${item.filename}</strong> <span style="color:var(--text-secondary); font-size:12px;">(${d})</span></div>`;
      });
      html += '</div><div style="margin-top:8px; font-size:11.5px; color:var(--text-secondary);">Fayllar brauzeringizning "Yuklamalar" papkasida saqlanadi.</div>';
      ...
      <div className="container">
        <div className="page-header">
          <div>
            ...
            <p style={{ margin: '4px 0 0', color: 'var(--text-secondary)' }}>Professional enterprise reports • 2026</p>
          </div>
        </div>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(240px, 1fr))', gap: 22 }}>
          <div className="card">
            <div className="card-body">
              ...
              <p style={{ fontSize: 13.5, color: 'var(--text-secondary)', margin: '8px 0 16px' }}>Barcha binolar, yig'ish darajasi, RUBS va qarzlar.</p>
          ...
          <div className="card">
            <div className="card-body">
              ...
              <p style={{ fontSize: 13.5, color: 'var(--text-secondary)', margin: '8px 0 16px' }}>Buxgalteriya uchun to'liq ma'lumotlar jadvali.</p>
          ...
          <div className="card">
            <div className="card-body">
              ...
              <p style={{ fontSize: 13.5, color: 'var(--text-secondary)', margin: '8px 0 16px' }}>O'zbekiston uchun XML eksport + CAM reconciliation.</p>
        ...
        <div className="card" style={{ marginTop: 26 }}>
          ...
          <div className="card-body">
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 30 }}>
              <div>
                <div style={{ marginBottom: 14, fontSize: 14, fontWeight: 600, color: 'var(--text)' }}>2026-07 yilgi natijalar</div>
                <table style={{ width: '100%', fontSize: 14 }}>
                  <tbody>
                    <tr><td style={{ padding: '6px 0', color: 'var(--text)' }}>Umumiy hisob</td><td style={{ textAlign: 'right', fontWeight: 700, color: 'var(--text)' }}>142.4M UZS</td></tr>
                    <tr><td style={{ padding: '6px 0', color: 'var(--text)' }}>Yig'ildi</td><td style={{ textAlign: 'right', fontWeight: 700, color: 'var(--success)' }}>117.3M UZS</td></tr>
                    <tr><td style={{ padding: '6px 0', color: 'var(--text)' }}>Kech to'lovlar</td><td style={{ textAlign: 'right', fontWeight: 700, color: 'var(--danger)' }}>25.1M UZS</td></tr>
                    <tr><td style={{ padding: '6px 0', borderTop: '1px solid var(--card-border)', color: 'var(--text)' }}>O'rtacha yig'ish</td><td style={{ textAlign: 'right', fontWeight: 700, color: 'var(--success)' }}>82.4%</td></tr>
                  </tbody>
                </table>
              </div>
              <div>
        ...
        <div className="card" style={{ marginTop: 22 }} id="recent-downloads-card">
          <div className="card-header">
            ...
            <span style={{ fontSize: 12, color: 'var(--text-secondary)' }}>(Brauzer yuklamalar papkasiga tushadi)</span>
          </div>
          <div className="card-body" id="recent-downloads">
            <div style={{ fontSize: 13.5, color: 'var(--text-secondary)' }}>Hali hisobot yuklanmagan. Yuqoridagi tugmalardan birini bosing.</div>
          </div>
        </div>
      </div>
